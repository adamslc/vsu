...
from vsu import clean
from vsu import history
...
def main():
    ...
    parser_run.add_argument("--extra-txpp-args", help="Extra arguments to be used during the final processing step but not included when finding the directory to save the simulation results", default="")
